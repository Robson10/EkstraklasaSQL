<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminForm.aspx.cs" Inherits="EkstraklasaWeb.Users.Admin.AdminForm" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            <asp:Panel ID="Panel1" runat="server" Width="200px" style="float:left">
                ...
                <br />
                <br />
                <asp:Button ID="BtNoweSpotkanie" runat="server" Text="Nowe Spotkanie" Width="200px" style="border: none;font-size: 16px;color: wheat;background-color: dimgray;height:30px" OnClick="BtNoweSpotkanie_Click" />
                <br />
                <br />
                ...
                <br />
                <br />
                <asp:Button ID="BtNowyZawodnik" runat="server" Text="Nowy Zawodnik" Width="200px"  style="border: none;font-size: 16px;color: wheat;background-color: dimgray;height:30px" OnClick="BtNowyZawodnik_Click"/>
                <br />
                <br />
                <asp:Button ID="BtDruzyny" runat="server" Text="Drużyny" Width="200px"  style="border: none;font-size: 16px;color: wheat;background-color: dimgray;height:30px" OnClick="BtDruzyny_Click"/>
                <br />
                <br />
            ...
            <asp:Button ID="AddRow" runat="server" Text="DodajWiersz" Width="200px"  style="border: none;font-size: 16px;color: wheat;background-color: dimgray;height:30px" OnClick="AddRow_Click"/>
            <br /><br />
                
            <asp:Panel ID="Panel2" runat="server" style="float:left">
                
                    <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Width="500px" OnRowDataBound="GridView1_RowDataBound"
